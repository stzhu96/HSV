...
def update_output_image_upload(contents):
    if contents is not None:
        ...
        return html.Div([
            ...
            html.P(f'H通道均值：{m.ravel().tolist()[2]:.2f}，H通道标准差：{dev.ravel().tolist()[2]:.2f}'),
            html.P(f'S通道均值：{m.ravel().tolist()[1]:.2f}，S通道标准差：{dev.ravel().tolist()[1]:.2f}'),
            html.P(f'V通道均值：{m.ravel().tolist()[0]:.2f}，V通道标准差：{dev.ravel().tolist()[0]:.2f}'),
        ])
